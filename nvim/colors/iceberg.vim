...
if &background == 'light'
  hi Normal ctermbg=254 ctermfg=255 guibg=#e8e9ec guifg=#33374c
  ...
  hi Normal ctermbg=0 ctermfg=252 guibg=#161821 guifg=#c6c8d1
  ...
  if has('nvim')
    ...
    let g:terminal_ansi_colors = ['#000000', '#e27878', '#b4be82', '#e2a478', '#84a0c6', '#a093c7', '#89b8c2', '#c6c8d1', '#6b7089', '#e98989', '#c0ca8e', '#e9b189', '#91acd1', '#ada0d3', '#95c4ce', '#d2d4de']
  endif
endif
