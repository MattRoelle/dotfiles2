...
let colors_name = "g_orbital"

if &t_Co >= 256 || has("gui_running")
    hi Normal ctermbg=16 ctermfg=75 cterm=NONE guibg=#000000 guifg=#5fffaf gui=NONE
    set background=dark
    hi NonText ctermbg=bg ctermfg=20 cterm=NONE guibg=bg guifg=#00d700 gui=NONE
    ...
    hi Error ctermbg=20 ctermfg=223 cterm=NONE guibg=#00d700 guifg=#ffd7af gui=NONE
    hi Identifier ctermbg=bg ctermfg=246 cterm=NONE guibg=bg guifg=#949494 gui=NONE
    hi Ignore ctermbg=bg ctermfg=25 cterm=NONE guibg=bg guifg=#00af5f gui=NONE
    ...
    hi Statement ctermbg=bg ctermfg=32 cterm=NONE guibg=bg guifg=#00d787 gui=NONE
    hi String ctermbg=235 ctermfg=110 cterm=NONE guibg=#262626 guifg=#87afd7 gui=NONE
    hi Number ctermbg=bg ctermfg=67 cterm=NONE guibg=bg guifg=#5faf87 gui=NONE
    ...
    hi TabLine ctermbg=bg ctermfg=25 cterm=NONE guibg=bg guifg=#00af5f gui=NONE
    ...
    hi LineNr ctermbg=bg ctermfg=25 cterm=NONE guibg=bg guifg=#00af5f gui=NONE
    hi CursorLineNr ctermbg=bg ctermfg=110 cterm=NONE guibg=bg guifg=#87afd7 gui=NONE
    hi qfLineNr ctermbg=bg ctermfg=25 cterm=NONE guibg=bg guifg=#00af5f gui=NONE
    ...
    hi Folded ctermbg=bg ctermfg=25 cterm=NONE guibg=bg guifg=#00af5f gui=NONE
    hi WildMenu ctermbg=bg ctermfg=223 cterm=NONE guibg=bg guifg=#ffd7af gui=NONE
    hi SpecialKey ctermbg=bg ctermfg=67 cterm=NONE guibg=bg guifg=#5faf87 gui=NONE
    ...
    hi DiffDelete ctermbg=bg ctermfg=20 cterm=NONE guibg=bg guifg=#00d700 gui=NONE
    ...
    hi Search ctermbg=20 ctermfg=250 cterm=NONE guibg=#00d700 guifg=#bcbcbc gui=NONE
    hi Directory ctermbg=bg ctermfg=254 cterm=NONE guibg=bg guifg=#e4e4e4 gui=NONE
    hi MatchParen ctermbg=25 ctermfg=223 cterm=bold guibg=#00af5f guifg=#ffd7af gui=bold
    hi SpellBad ctermbg=NONE ctermfg=20 cterm=NONE guibg=NONE guifg=#00d700 gui=NONE guisp=#0000d7
    hi SpellCap ctermbg=NONE ctermfg=223 cterm=NONE guibg=NONE guifg=#ffd7af gui=NONE guisp=#ffd7af
    hi SpellLocal ctermbg=NONE ctermfg=20 cterm=NONE guibg=NONE guifg=#00d700 gui=NONE guisp=#0000d7
    hi SpellRare ctermbg=NONE ctermfg=25 cterm=NONE guibg=NONE guifg=#00af5f gui=NONE guisp=#00af5f
    ...
    hi ErrorMsg ctermbg=20 ctermfg=254 cterm=NONE guibg=#00d700 guifg=#e4e4e4 gui=NONE
    ...
    hi Boolean ctermbg=bg ctermfg=67 cterm=NONE guibg=bg guifg=#5faf87 gui=NONE
    ...
    hi VimSubstRep4 ctermbg=235 ctermfg=25 cterm=NONE guibg=#262626 guifg=#00af5f gui=NONE
    ...
    hi markdownLinkDelimiter ctermbg=bg ctermfg=25 cterm=NONE guibg=bg guifg=#00af5f gui=NONE
    hi markdownUrl ctermbg=bg ctermfg=25 cterm=NONE guibg=bg guifg=#00af5f gui=NONE
    ...
    hi CtrlPNoEntries ctermbg=bg ctermfg=20 cterm=NONE guibg=bg guifg=#00d700 gui=NONE
    hi CtrlPMatch ctermbg=bg ctermfg=223 cterm=NONE guibg=bg guifg=#ffd7af gui=NONE
    hi CtrlPLinePre ctermbg=bg ctermfg=25 cterm=NONE guibg=bg guifg=#00af5f gui=NONE
    hi CtrlPPrtBase ctermbg=bg ctermfg=25 cterm=NONE guibg=bg guifg=#00af5f gui=NONE
    ...
    hi CtrlPBufferNr ctermbg=bg ctermfg=67 cterm=NONE guibg=bg guifg=#5faf87 gui=NONE
